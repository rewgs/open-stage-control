...
- branch `package-updates-2`
  - `@babel/core`: 7.24.3 → 7.25.2
  - `@babel/eslint-parser`: 7.24.1 → 7.28.0
  - `@babel/plugin-transform-object-rest-spread`: 7.24.0 → 7.24.7
  - `@babel/preset-env`: 7.24.3 → 7.25.4
  - `core-js`: 3.36.1 → 3.38.1
  - `@electron/packager`: 18.1.3 → 18.3.5
  - `nodemon`: 3.1.0 → 3.1.4
  - `sass`: 1.72.0 → 1.77.8
  - `semver`: 7.6.0 → 7.6.3
  - `ws`: 8.16.0 → 8.18.0
  - `electron`: 29.1.4 → 32.0.1 (major version update)
  - `eslint`: Kept at 8.57.0 (v9+ requires new config format incompatible with existing setup)
  - `open`: Kept at 7.4.2 (v8+ is ESM-only)
