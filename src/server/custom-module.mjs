                  ...
                  loadJSON: (url, errorCallback) => {
                      try {
                          ...
                          if (typeof errorCallback === "function") {
                              ...
                              console.error(
                                  "(ERROR, CUSTOM MODULE) could not load json file from " +
                                      url
                              );
                  ...
                  saveJSON: (url, data, errorCallback) => {
                      ...
                      try {
                          ...
                          if (typeof errorCallback === "function") {
                              ...
                              console.error(
                                  "(ERROR, CUSTOM MODULE) could not save json file to " +
                                      url
                              );
                              console.error(e.message);
                          }
        ...
        this.watcher = chokidar
            ...
            .on("change", () => {
                if (this.submodule) {
                    ...
                    console.log(
                        "(INFO) Custom module changed: " + this.filename
                    );
                    this.reload();
                }
            });
    ...
    load() {
        ...
        try {
            code = fs.readFileSync(this.filename, {
                encoding: "utf8",
                flag: "rs"
            }); // flag 'rs' to avoid cache issue on windows
        } catch (err) {
            console.error(
                `(ERROR, CUSTOM MODULE) Module not found: ${this.filename}`
            );
            return false;
        }
    ...
    unload() {
        ...
        if (this.module.exports && this.module.exports.unload) {
            try {
                ...
                console.error(
                    "(ERROR, CUSTOM MODULE) Error while calling unload()"
                );
                console.error(e);
            }
        }
        ...
        if (this.load()) {
            ...
            if (this.module.exports && this.module.exports.reload) {
                try {
                    ...
                    console.error(
                        "(ERROR, CUSTOM MODULE) Error while calling custom module reload function"
                    );
                    console.error(e);
                }
            }
            ...
            console.error(
                "(ERROR, CUSTOM MODULE) Failed to reload custom module"
            );
            this.unload();
        }
    }
    ...
    stop() {
        if (this.module.exports && this.module.exports.stop) {
            try {
                ...
                console.error(
                    "(ERROR, CUSTOM MODULE) Error while calling custom module stop function"
                );
                console.error(e);
            }
        }
