// var { resolvePath, ipc } = require("./server.mjs"),
//     callbacks = require("./callbacks.mjs"),
//     chokidar = require("chokidar");

import "chokidar";

import "./callbacks.mjs";
import { resolvePath, ipc } from "./server.mjs";
...
/**
 * FIXME: I don't love that we're exporting an instance of a class here...
 * Look into only importing class itself and instantiating from there.
 */

// module.exports = new FragmentManager();
export default new FragmentManager();
