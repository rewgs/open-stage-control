// var customEvents = {};
// setTimeout(() => {
// customEvents["draginit"] =
//     customEvents["drag"] =
//     customEvents["dragend"] =
//         require("./drag");
// customEvents["resize"] = require("./resize");
// customEvents["wheel"] = require("./dom-event")("wheel");
// customEvents["scroll"] = require("./dom-event")("scroll", {
//     capture: true
// });
...
import { triggerEvent } from "./dom-event.mjs";
...
let customEvents = {
    ...
    dragend: drag,
    resize: resize,
    wheel: triggerEvent("wheel"),
    scrool: triggerEvent("scroll", { capture: true }),
    click: triggerEvent("click"),
    "fast-click": triggerEvent("fast-click"),
    focus: triggerEvent("focus", { capture: true }),
    blur: triggerEvent("blur", { capture: true }),
...
//                             this._customBindings[evt]--;
//                             if (this._customBindings[evt] === 0) {
//                                 customEvents[evt].teardown.call(
//                                     this,
//                                     listener._options
//                                 );
