...
export class Pad extends Canvas {
    constructor(options) {
        super({
            ...options,
            value: [],
    ...
    cacheCanvasStyle(style) {
        ...
        this.padPadding =
            this.cssVars.padding + this.cssVars.lineWidth + 2 * PXSCALE;
        this.pointSize =
            parseFloat(this.cssVars.pointSize) *
            (this.cssVars.pointSize.indexOf("%") > -1
                ? this.width / 100
                : PXSCALE);
    }
...
Pad.dynamicProps = Pad.prototype.constructor.dynamicProps
    .filter((n) => n !== "decimals")
    .concat(["spring", "axisLock", "pointSize", "label"]);
