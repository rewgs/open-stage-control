...
export class CanvasWidget extends Canvas {
    ...
    static defaults() {
        ...
        defaults.scripting = {
            onCreate: {
                ...
                editor: "javascript",
                help: [
                    'Script executed when the widget is created. See <a href="https://openstagecontrol.ammd.net/docs/widgets/scripting/">documentation</a>.'
                ]
            },
            onValue: {
                type: "script",
                ...
                editor: "javascript",
                help: [
                    'Script executed whenever the widget\'s value updates. See <a href="https://openstagecontrol.ammd.net/docs/widgets/scripting/">documentation</a>.'
                ]
            },
            onTouch: {
                type: "script",
                ...
                editor: "javascript",
                help: [
                    'Script executed when the widget is touched and released, and when the pointer moves when the widget is touched. See <a href="https://openstagecontrol.ammd.net/docs/widgets/canvas/">documentation</a>.'
                ]
            },
            onDraw: {
                type: "script",
            ...
            onResize: {
                ...
                editor: "javascript",
                help: [
                    'Script executed when the widget is resized. See <a href="https://openstagecontrol.ammd.net/docs/widgets/canvas/">documentation</a>.'
                ]
            }
        };
        return defaults;
    ...
    constructor(options) {
        ...
        this.valueLength = Math.max(
            1,
            parseInt(this.getProp("valueLength")) || 1
        );
    ...
    setValue(v, options = {}) {
        ...
        if (options.defaultInit && this.script)
            this.script.setValue(this.value, { id: this.getProp("id") });
    }
