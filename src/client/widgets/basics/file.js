        ...
        return super.defaults().extend({
            style: {
                ...
                hidePath: {
                    type: "boolean",
                    value: false,
                    help: "Set to `true` to only display the filename (the whole path will still be used as value)"
                },
                mode: {
                    type: "string",
                    value: "open",
                    choices: ["open", "save"],
                    help: "File browser mode"
                }
            },
            class_specific: {
                directory: {
                    type: "string",
                    value: "auto",
                    help: "Default browsing directory"
                },
                extension: {
                    type: "string|array",
                    value: "*",
                    help: 'Only display files with this extension. Multiple extensions can be specified with an array of strings (`["jpg", "jpeg"]`)'
                },
                allowDir: {
                    type: "boolean",
                    value: false,
                    help: 'Allow selecting a folder (by pressing "open" when no file is selected)'
                }
            }
        });
    }
                ...
                uiFilebrowser(
                    {
                        ...
                        directory:
                            this.getProp("directory") === "auto"
                                ? undefined
                                : this.getProp("directory"),
