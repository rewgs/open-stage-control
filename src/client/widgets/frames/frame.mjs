...
export class Frame extends StaticProperties(Widget, { bypass: true }) {
    ...
    constructor(options) {
        ...
        if (this.getProp("allow"))
            this.frame.setAttribute("allow", this.getProp("allow"));

        this.errorText = html`<span
            >${locales("iframe_unauthorized")}<span></span
        ></span>`;
