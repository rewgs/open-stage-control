// var osc = require("../../osc");
// var { isJSON, isJSONObject } = require("../../utils");
...
//             if (this.address[0] !== "/") {
//                 var parentAddress =
//                     this.parent.getProp("address") ||
//                     this.parent.resolveProp("address", undefined, false, this);
//                 if (parentAddress === "auto") {
//                     var id =
//                         this.parent.getProp("id") ||
//                         this.parent.resolveProp("id", undefined, false, this);
//                     parentAddress = "/" + id;
//                 }
...
//             }
//
//             osc.on(this.prefix + this.address, this.boundCallback, {
//                 context: this.parent
//             });
//         }
//     }
...
//         var preArgs = this.usePreArgs
//             ? this.parent.getProp("preArgs") || []
//             : [];
