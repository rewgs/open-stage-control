...
//             Math.min(value, Math.max(range[0], range[1]))
//         );
//     },
//
...
//         // log scale
//         if (log) {
//             var logScale = revertlog
//                 ? Math.abs(rangeIn[1] - rangeIn[0])
...
//                 : Math.pow(logScale, value) / (logScale - 1) -
//                   1 / (logScale - 1);
//         }
//
//         // scale out
...
//
//         while (
//             (start = string.indexOf(tag + open)) >= 0 &&
//             lastStart !== start
//         ) {
