...
export class Eq extends StaticProperties(Plot, {
    logScaleX: false,
    logScaleY: false,
    smooth: true
}) {
        ...
        return super.defaults().extend({
            ...
            class_specific: {
                ...
                rangeY: {
                    type: "object",
                    value: { min: -6, max: 6 },
                    help: "Defines the min and max values for the y axis (in dB)"
                },
                origin: {
                    type: "number|boolean",
                    value: "auto",
    ...
    calcResponse() {
        ...
        for (let i = 0; i < resolution; ++i) {
            frequencyHz[i] = mapToScale(
                i,
                [0, this.width],
                [this.getProp("rangeX").min, this.getProp("rangeX").max],
                -1,
                true
            );
        }
...
Eq.dynamicProps = Eq.prototype.constructor.dynamicProps.concat("filters");

// module.exports = Eq;

// AR note -- is this used?
//
// biquadResponse
