...
//         "Liste non chargée, veuillez fermer puis ouvrir le menu à nouveau",
...
//     fs_addtohome:
//         "Vous devez ajouter cette page à votre écran d'accueil pour pouvoir l'ouvrir en plein écran.",
//
//     // fragment mode
//     fragment_mode: "Mode fragment",
//     fragment_mode_warning: "Mode fragment activé",
//     fragment_mode_explanation:
//         "La session sera enregistrée sous forme de fragment : seul le premier descendant de l'élément root sera sauvegardé.",
//
//     // inspector
//     inspector_error:
//         "Une erreur vient de survenir, ouvrez la console pour en savoir plus.",
...
//         "Un fichier du même nom existe déjà, voulez le remplacer ?",
//     remotesave_fail:
//         'Le fichier n\'a pas pu être enregistré sur le serveur, utilisez la fonction "exporter"',
//     remotesave_success: "Le fichier a été enregistré avec succès",
//     remotesave_forbidden:
//         'Vous n\'êtes pas autorisé à sauvegarder sur le serveur, utilisez la fonction "exporter"',
//
//     // server
...
//     session_unsaved:
//         "Vos modifications seront perdues si vous fermez la session actuelle sans sauvegarder, continuer ?",
//     session_oldversion_title: "Attention",
//     session_oldversion:
//         "Cette session a été créée avec une ancienne version de ce logiciel, une conversion automatique a été appliquée. Une fois sauvegardée, cette session risque de ne plus charger correctement avec les anciennes versions, il est recommandé d'en faire une copie de sauvegarde.",
//
//     // state
//     state: "État",
//     state_store: "Sauver",
